...
// TITLE :          AbstractSubstance 
// DESCRIPTION :    Tuple abstraction of geometrical substance 
// AUTHOR(S) :      Vincent Reverdy (vince.rev@gmail.com) 
// CONTRIBUTIONS :  [Vincent Reverdy (2012-2013)] 
// LICENSE :        CECILL-B License 
/*////////////////////////////////////////////////////////////////////////////*/
/// \file           abstractsubstance.h 
/// \brief          Tuple abstraction of geometrical substance 
/// \author         Vincent Reverdy (vince.rev@gmail.com) 
/// \date           2012-2013 
/// \copyright      CECILL-B License 
/*////////////////////////////////////////////////////////////////////////////*/
#ifndef ABSTRACTSUBSTANCE_H_INCLUDED
#define ABSTRACTSUBSTANCE_H_INCLUDED
/*////////////////////////////////////////////////////////////////////////////*/
...
/// \brief          Tuple abstraction of geometrical substance. 
/// \details        This class is an abstraction of the substance of 
///                 geometrical entities. This abstraction provides 
///                 standardized access to generic types of internal data. 
...
class AbstractSubstance
{
    ...
    public: 
        inline AbstractSubstance(); 
        template <class OtherCrtp, class... OtherTypes> explicit inline AbstractSubstance(const AbstractSubstance<OtherCrtp, OtherTypes...>& source); 
        template <class... OtherTypes> explicit inline AbstractSubstance(const std::tuple<OtherTypes...>& source); 
        template <class... OtherTypes, class = typename std::enable_if<(sizeof...(OtherTypes) != 0) && (std::is_constructible<typename std::tuple_element<0, typename std::conditional<sizeof...(Types) != 0, std::tuple<Types...>, std::tuple<std::true_type> >::type>::type, typename std::tuple_element<0, typename std::conditional<sizeof...(OtherTypes) != 0, std::tuple<OtherTypes...>, std::tuple<std::true_type> >::type>::type>::value)>::type> explicit inline AbstractSubstance(const OtherTypes&... source); 
    //@}
    ...
    public: 
        ...
        template <class OtherCrtp, class... OtherTypes> inline bool operator==(const AbstractSubstance<OtherCrtp, OtherTypes...>& rhs) const; 
        template <class OtherCrtp, class... OtherTypes> inline bool operator!=(const AbstractSubstance<OtherCrtp, OtherTypes...>& rhs) const; 
    //@}
    ...
    public: 
        inline Crtp& assign(); 
        inline Crtp& assign(const AbstractSubstance<Crtp, Types...>& source); 
        template <class OtherCrtp, class... OtherTypes> inline Crtp& assign(const AbstractSubstance<OtherCrtp, OtherTypes...>& source); 
    ...
    //@{
    public: 
        template <class SelfCrtp, class... SelfTypes> friend std::ostream& operator<<(std::ostream& lhs, const AbstractSubstance<SelfCrtp, SelfTypes...>& rhs); 
    //@}
...
template <class Crtp, class... Types>
inline AbstractSubstance<Crtp, Types...>::~AbstractSubstance()
= default;
//--------------------------------------------------------------------------- //
...
inline AbstractSubstance<Crtp, Types...>::AbstractSubstance(const AbstractSubstance<OtherCrtp, OtherTypes...>& source)
...
inline AbstractSubstance<Crtp, Types...>::AbstractSubstance(const std::tuple<OtherTypes...>& source)
...
inline AbstractSubstance<Crtp, Types...>::AbstractSubstance(const OtherTypes&... source)
: _data(transmute<std::tuple<Types...> >(source...))
{
    ;
}
...
template <class Crtp, class... Types>
inline Crtp& AbstractSubstance<Crtp, Types...>::operator=(const AbstractSubstance<Crtp, Types...>& rhs)
{
    _data = rhs._data;
...
template <class Crtp, class... Types>
template <class OtherCrtp, class... OtherTypes>
inline Crtp& AbstractSubstance<Crtp, Types...>::operator=(const AbstractSubstance<OtherCrtp, OtherTypes...>& rhs)
{
...
template <class Crtp, class... Types>
template <class... OtherTypes>
inline Crtp& AbstractSubstance<Crtp, Types...>::operator=(const std::tuple<OtherTypes...>& rhs)
{
...
template <class Crtp, class... Types>
template <class OtherCrtp, class... OtherTypes>
inline bool AbstractSubstance<Crtp, Types...>::operator==(const AbstractSubstance<OtherCrtp, OtherTypes...>& rhs) const
{
...
/// \return         Self reference. 
template <class Crtp, class... Types>
inline Crtp& AbstractSubstance<Crtp, Types...>::assign()
{
    _data = std::tuple<Types...>();
    return static_cast<Crtp&>(*this);;
}
...
/// \return         Self reference. 
template <class Crtp, class... Types>
inline Crtp& AbstractSubstance<Crtp, Types...>::assign(const AbstractSubstance<Crtp, Types...>& source)
{
    _data = source._data;
    return static_cast<Crtp&>(*this);;
}
...
template <class Crtp, class... Types>
template <class OtherCrtp, class... OtherTypes>
inline Crtp& AbstractSubstance<Crtp, Types...>::assign(const AbstractSubstance<OtherCrtp, OtherTypes...>& source)
{
    _data = transmute<std::tuple<Types...> >(source.data());
    return static_cast<Crtp&>(*this);
}
...
template <class Crtp, class... Types>
template <class... OtherTypes>
inline Crtp& AbstractSubstance<Crtp, Types...>::assign(const std::tuple<OtherTypes...>& source)
{
    _data = transmute<std::tuple<Types...> >(source);
    return static_cast<Crtp&>(*this);
}
...
template <class Crtp, class... Types>
template <class... OtherTypes, class>
inline Crtp& AbstractSubstance<Crtp, Types...>::assign(const OtherTypes&... source)
{
    _data = transmute<std::tuple<Types...> >(source...);
    return static_cast<Crtp&>(*this);
}
...
/// \return         Self reference. 
template <class Crtp, class... Types>
inline Crtp& AbstractSubstance<Crtp, Types...>::nullify()
{
    _data = std::tuple<Types...>();
    return static_cast<Crtp&>(*this);
}
...
/// \return         Copy. 
template <class Crtp, class... Types>
inline Crtp AbstractSubstance<Crtp, Types...>::copy() const
{
...
inline OtherCrtp AbstractSubstance<Crtp, Types...>::cast() const
{
...
inline Type& AbstractSubstance<Crtp, Types...>::data(Dummy...)
{
    return _data;
}
...
template <class Crtp, class... Types>
template <class... Dummy, class Type, class, class>
inline const Type& AbstractSubstance<Crtp, Types...>::data(Dummy...) const
{
    return _data;
}
...
inline Crtp& AbstractSubstance<Crtp, Types...>::data(const Type& value)
{
    _data = value;
    return static_cast<Crtp&>(*this);
}
...
inline Type& AbstractSubstance<Crtp, Types...>::data(const Subscript subscript, Dummy...)
{
...
template <class Crtp, class... Types>
template <unsigned int Index, typename Subscript, class... Dummy, class Type, class, class, class, class>
inline const Type& AbstractSubstance<Crtp, Types...>::data(const Subscript subscript, Dummy...) const
{
    return std::get<Index>(_data)[subscript];
}
...
inline Crtp& AbstractSubstance<Crtp, Types...>::data(const Subscript subscript, const Type& value)
{
...
template <class Crtp, class... Types>
template <class Type, class>
inline const Type& AbstractSubstance<Crtp, Types...>::get() const
{
    return _data;
}
...
inline const Type& AbstractSubstance<Crtp, Types...>::get(Dummy...) const
{
    return std::get<Index>(_data);
}
...
inline const Type& AbstractSubstance<Crtp, Types...>::get(const Dummy&...) const
{
    return std::get<Subscript>(std::get<Index>(_data));
}
...
inline const Type& AbstractSubstance<Crtp, Types...>::get(const unsigned int subscript) const
{
    return std::get<Index>(_data)[subscript];
}
//--------------------------------------------------------------------------- //
...
template <class Crtp, class... Types>
template <class Type, class>
inline Crtp& AbstractSubstance<Crtp, Types...>::set(const Type& value)
{
    _data = value;
    return static_cast<Crtp&>(*this);
}
...
template <class Crtp, class... Types>
template <unsigned int Index, class Type, class... Dummy, class>
inline Crtp& AbstractSubstance<Crtp, Types...>::set(const Type& value, Dummy...)
{
    std::get<Index>(_data) = value;
    return static_cast<Crtp&>(*this);
}
...
template <class Crtp, class... Types>
template <unsigned int Index, unsigned int Subscript, class Type, class... Dummy, class>
inline Crtp& AbstractSubstance<Crtp, Types...>::set(const Type& value, const Dummy&...)
{
    std::get<Subscript>(std::get<Index>(_data)) = value;
    return static_cast<Crtp&>(*this);
}
...
template <class Crtp, class... Types>
template <unsigned int Index, class Type, class>
inline Crtp& AbstractSubstance<Crtp, Types...>::set(const unsigned int subscript, const Type& value)
{
    std::get<Index>(_data)[subscript] = value;
    return static_cast<Crtp&>(*this);
}
...
template <class Crtp, class... Types>
template <class Type, class>
constexpr Type AbstractSubstance<Crtp, Types...>::type()
{
    return Type();
}
...
template <class Crtp, class... Types>
template <unsigned int Index, class Type, class... Dummy, class>
constexpr Type AbstractSubstance<Crtp, Types...>::type(Dummy...)
{
    return Type();
}
...
template <class Crtp, class... Types>
template <unsigned int Index, unsigned int Subscript, class Type, class... Dummy, class>
constexpr Type AbstractSubstance<Crtp, Types...>::type(const Dummy&...)
{
    return Type();
}
...
template <class Crtp, class... Types>
template <unsigned int Index, class Type, class>
constexpr Type AbstractSubstance<Crtp, Types...>::type(const unsigned int subscript)
{
...
template <class Crtp, class... Types>
constexpr unsigned int AbstractSubstance<Crtp, Types...>::types()
{
...
constexpr Type AbstractSubstance<Crtp, Types...>::monomial(Type&& value)
{
...
constexpr Type AbstractSubstance<Crtp, Types...>::monomial(Type&& value, Dummy...)
{
...
constexpr Output AbstractSubstance<Crtp, Types...>::transmute()
{
    return Output();
}
...
constexpr Input AbstractSubstance<Crtp, Types...>::transmute(Input&& input)
{
...
template <class Crtp, class... Types>
template <class Output, class... Input, class>
constexpr Output AbstractSubstance<Crtp, Types...>::transmute(const Input&... input)
{
...
template <class Crtp, class... Types>
template <class Output, class... Input, class>
constexpr Output AbstractSubstance<Crtp, Types...>::transmute(Input&&... input)
{
...
constexpr bool AbstractSubstance<Crtp, Types...>::printable(typename std::enable_if<!std::is_void<decltype(std::declval<std::ostream&>()<<std::declval<Input>())>::value>::type*)
{
    return true;
}
...
constexpr bool AbstractSubstance<Crtp, Types...>::printable(Dummy...)
{
    return false;
}
...
inline bool AbstractSubstance<Crtp, Types...>::print(std::ostream& stream, Input&& input)
{
...
template <class Crtp, class... Types>
template <class Input, class>
inline bool AbstractSubstance<Crtp, Types...>::print(std::ostream& stream, const Input& input)
{
...
inline bool AbstractSubstance<Crtp, Types...>::print(std::ostream& stream, const Input& input, Dummy...)
{
...
inline bool AbstractSubstance<Crtp, Types...>::print(std::ostream& stream, const Dummy&...)
{
    return stream.good();
}
//--------------------------------------------------------------------------- //
...
/// \details        Tests and demonstrates the use of AbstractSubstance. 
/// \return         0 if no error. 
template <class Crtp, class... Types>
int AbstractSubstance<Crtp, Types...>::example()
{
    std::cout<<"BEGIN = AbstractSubstance::example()"<<std::endl;
    std::cout<<std::endl;
    std::cout<<"ERROR = AbstractSubstance::example() : no example is provided for an abstract class"<<std::endl;
    std::cout<<std::endl;
    std::cout<<"END = AbstractSubstance::example()"<<std::endl;
    return 1;
}
//--------------------------------------------------------------------------- //
...
#endif // ABSTRACTSUBSTANCE_H_INCLUDED
/*////////////////////////////////////////////////////////////////////////////*/
